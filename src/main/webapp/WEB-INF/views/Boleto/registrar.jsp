...
<body>
	<div class="container">
		<h3 style="margin-top: 20px" align="center">¡Boleto - Registrar!</h3>
		...
		<div class="shadow-lg p-4 mb-4 bg-white border border-2" style="width: 370px; margin: 20px auto; border-radius: 10px">
			...
			<form:input class="form-control" type="number" path="nroButaca"/> <br>
			
			<label>Precio:</label> 
			<form:input class="form-control" type="text" step="any" path="precio"/> <br>
			
			<label>F.Compra:</label> 
			<form:input class="form-control" type="date" path="fcompra"/> <br>
			
			<label>TipoBoleto:</label>
			<form:input class="form-control" type="text" path="tipoBoleto"/> <br>
